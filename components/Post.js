    ...
    return (
        <div className="bg-white my-7 border rounded-sm">
            ...
            <div className="flex items-center p-5">
                <img className="rounded-full h-12 object-contain border p-1 mr-3" src={userImg} alt={id} />
            ...
            {session && (
                <form className="flex items-center p-4">
                    ...
                    <input value={comment} onChange={e => setComment(e.target.value)} placeholder="Add a comment..." className="border-none flex-1 focus:ring-0 outline-none" type="text" />
